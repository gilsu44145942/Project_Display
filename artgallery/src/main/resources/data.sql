...
('시간의 정원', 'POSTER_IMG', '이 전시는 사계절을 주제로 구성된 공간 속에서 시간이 흐르는 방식과 그 속의 자연 변화를 체험할 수 있도록 설계되었습니다. 각 공간은 계절마다 다른 정서와 색채를 담고 있습니다.', '2024-08-01', '2024-08-30', 12000),
...
('기억의 조각들', 'POSTER_IMG', '개인의 기억과 집단의 역사를 시각적으로 엮어낸 전시입니다. 사진, 텍스트, 설치 미술이 어우러져 관람객에게 자신만의 기억을 떠올릴 수 있는 장을 제공합니다.', '2024-11-01', '2024-11-25', 11000),
...
('움직이는 정물화', 'POSTER_IMG', '전통 정물화에 생명을 불어넣은 작품들을 중심으로 구성된 전시입니다. 디지털 기술과 회화의 접목을 통해 기존 회화의 고정관념을 넘어서는 새로운 시도를 엿볼 수 있습니다.', '2025-03-10', '2025-04-05', 10000),
('사라지는 풍경들', 'POSTER_IMG', '개발과 도시화로 점차 사라지는 공간을 기록하고자 하는 의도로 기획된 전시입니다. 회화, 영상, 인터뷰 기록이 함께 어우러져 감성적이면서도 사회적 메시지를 전달합니다.', '2024-10-15', '2024-11-10', 8500),
('소리 없는 이야기', 'POSTER_IMG', '청각적 요소가 배제된 시각적 작품들로만 구성된 전시로, 조용한 공간에서 오직 시각적 감각에 집중할 수 있는 기회를 제공합니다. 침묵 속에서 들려오는 이야기들을 감상해 보세요.', '2025-05-01', '2025-05-31', 10500),
('흑백의 미학', 'POSTER_IMG', '모든 작품이 흑백의 명암만으로 구성된 전시로, 색채 없이 표현되는 세상의 다양한 면모를 보여줍니다. 고요하지만 강렬한 대비가 인상적인 작품들을 만날 수 있습니다.', '2024-12-01', '2024-12-26', 9900);
