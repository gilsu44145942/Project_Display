...
INSERT INTO drawing (img_url, title, description, completion_date, is_complete, user_gallery_id, user_id)
VALUES
('IMG_URL', '비 오는 날의 창가', '창밖으로 떨어지는 빗방울을 따라 그려낸 몽환적인 드로잉입니다.', '2025-05-30', true, 1, 'artlover01'),
('IMG_URL', '따뜻한 오후의 햇살', '햇살이 창틀에 머무는 그 순간을 포착한 그림입니다.', '2025-06-01', true, 1, 'artlover01'),
('IMG_URL', '가로등 아래 그림자', '늦은 밤 가로등 빛에 비친 나무 그림자를 표현했습니다.', '2025-06-03', false, 1, 'artlover01'),
('IMG_URL', '빛바랜 창문', '오래된 기억처럼 빛이 바랜 유리창에서 느낀 감정들을 담았습니다.', '2025-05-25', true, 1, 'artlover01'),

('IMG_URL', '보라빛 꿈', '꿈에서 본 장면을 보라색 계열로 재현한 추상 드로잉입니다.', '2025-07-05', true, 2, 'drawmaster'),
('IMG_URL', '무중력 공간', '시간과 공간의 경계가 모호한 상상의 세계를 표현했습니다.', '2025-07-07', true, 2, 'drawmaster'),
('IMG_URL', '파도와 우주', '바다와 우주가 하나 되는 상상 속 풍경을 담았습니다.', '2025-07-06', false, 2, 'drawmaster'),
('IMG_URL', '잠들기 전의 이미지', '눈을 감기 직전 스치는 이미지들을 빠르게 그려낸 드로잉입니다.', '2025-07-04', true, 2, 'drawmaster'),

('IMG_URL', '고양이의 오후 산책', '따뜻한 햇살 아래 유유히 걷는 고양이의 모습을 그렸습니다.', '2025-05-22', true, 3, 'catncanvas'),
('IMG_URL', '창가의 고양이', '창틀에 앉아 세상을 바라보는 고양이의 눈빛을 포착했습니다.', '2025-05-23', true, 3, 'catncanvas'),
('IMG_URL', '털 사이로 보이는 마음', '고양이의 부드러운 털과 따뜻한 시선을 디테일하게 표현했습니다.', '2025-05-25', false, 3, 'catncanvas'),

('IMG_URL', '숨바꼭질', '놀이터에서 숨는 아이의 모습을 귀엽게 표현한 드로잉입니다.', '2025-04-12', true, 4, 'dreamybrush'),
('IMG_URL', '색연필 낙서', '아이처럼 자유롭게 그려낸 낙서 같은 그림입니다.', '2025-04-13', true, 4, 'dreamybrush'),
('IMG_URL', '유년의 숲', '어릴 적 뛰어놀던 숲속의 기억을 몽환적으로 표현했습니다.', '2025-04-15', false, 4, 'dreamybrush'),
('IMG_URL', '소꿉놀이 풍경', '소꿉놀이하며 만들어낸 상상의 풍경들을 담았습니다.', '2025-04-11', true, 4, 'dreamybrush');
